...
#ifndef _OPTIONS_H
#define _OPTIONS_H
typedef enum { OPTION_SCALAR, OPTION_INTEGER, OPTION_III, OPTION_SSS,OPTION_SS,OPTION_II,OPTION_ISPAIR,OPTION_IIPAIR,OPTION_SPECIAL1,OPTION_PSO} option_type;
