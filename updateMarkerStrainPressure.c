...
/*  PetscScalar dy = grid->dy;*/
  PetscInt NX = grid->NX;
  PetscInt NY = grid->NY;
  Vec dsxxl, dsyyl, dszzl, dsxyl, dsxzl, dsyzl, soxxl,soyyl,sozzl,soxyl,soxzl,soyzl,exxl,eyyl,ezzl,exyl,exzl,eyzl,wxyl,wxzl,wyzl,pl;
  PetscScalar **dsxx, **dsyy, **dszz, **dsxy, **dsxz, **dsyz, **soxx,**soyy,**sozz,**soxy,**soxz,**soyz,**exx,**eyy,**ezz,**exy,**exz,**eyz,**wxy,**wxz,**wyz,**p;
