...
%load the nodal fields too
dofields =1;
% if(dofields)
%     cd /Users/max/projects/markercode/vep/ridges/output;
%     cmd1 = sprintf('loadNodalFields_%d_%d',iMonte,iTime);
%     eval(cmd1)
%     
% end
...
fn= '/mnt/cluster/runs/ridge-oscillatory/output/GriddedMarkers.0.20';
